...
def run(rank, size, model, args, train_data, weight):
...
def init_processes(rank, size, model, args, train_data, weight, backend='mpi'):
    dist.init_process_group(backend, rank=rank, world_size=size)
    run(rank, size, model, args, train_data, weight)